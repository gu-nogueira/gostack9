...
// O estado do redux é imutável, então todo reducer terá uma estrutura parecida
...
export default function cart(state = [], action) {
  ...
  switch (action.type) {
    // Então, caso o type da action seja 'ADD_SUCCESS', podemos modificar o estado da maneira que quisermos
    case '@cart/ADD_SUCCESS':
      return produce(state, draft => {
        // Aqui podemos fazer as alterações normalmente, sem se preocupar com a imutabilidade do state, podendo usar o .push no array convencional do javascript. Isso graças a função 'produce' do immer
