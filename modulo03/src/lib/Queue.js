...
class Queue {
  ...
  handleFailure(job, err) {
    // Por fim, exibimos o possível erro no console da execução de fila (Queue.js)
    // Mais para frente colocaremos este log em um lugar onde conseguiremos acessar com a aplicação em produção
